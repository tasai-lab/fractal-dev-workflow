...
```bash
# Phase 7に移動
./scripts/workflow-manager.sh set-phase "$wf_id" 7

# この状態でWrite/Editを試みる → ブロックされるはず
# Expected error: "Phase 6 (コードレビュー) のCodex承認とユーザー承認が必要です"

# Codex承認
approve "$wf_id" "6" "codex"

# User承認
approve "$wf_id" "6" "user"
